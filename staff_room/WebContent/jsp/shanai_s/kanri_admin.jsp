...
<%
	...
	if(table_select.equals("holiday")){
		...
		for(int w = 0;w < a_count;w++){
			sql = "insert into KINMU.HOLIDAY values('" + shuku_day[w] + "','" + shuku_name[w] + "')";
			upData.execute(sql);
		}
	}
	...
	if(table_select.equals("user")){
		if(sql_select.equals("ins")){
			...
			if(teishi_flg.equals("0")){
				sql = "insert into KINMU.KOJIN(K_社員No,K_承認LV,K_ID,K_PASS,K_氏名,K_GRUNo,K_MAIL) values('" + k_no + "','" + k_lv + "','" + k_id + "','" + k_pass + "','" + k_name + "','" + k_gruno + "','" + k_mail + "')";
			}
			...
			if(teishi_flg.equals("0")){
				sql = "update KINMU.KOJIN set K_承認Lv='" + k_lv + "',K_ID='" + k_id + "',K_PASS='" + k_pass + "',K_氏名='" + k_name + "',K_GRUNo='" + k_gruno + "',K_MAIL='" + k_mail + "' where K_社員NO='" + k_no + "'";
			}			
		}
	}
	if(table_select.equals("gru")){
		if(sql_select.equals("ins")){
			...
			if(teishi_flg.equals("0")){
				sql = "insert into KINMU.GRU values('" + g_code + "','" + g_name + "')";
			}
		}else if(sql_select.equals("del")){
			...
			if(teishi_flg.equals("0")){
				sql = "update KINMU.GRU set G_GRUNO='" + gr_num + "',G_GRNAME='" + gr_name + "' where G_GRUNO='" + gr_num + "'";
			}			
		}
	}
	...
	if(table_select.equals("yotei")){
		if(sql_select.equals("ins")){
			...
			if(teishi_flg.equals("0")){
				sql = "insert into KINMU.yotei values('" + y_kubun + "','" + y_naiyou + "','" + y_junban + "')";
			}
		}else if(sql_select.equals("del")){
			String y_kubun = request.getParameter("y_kubun");
			String y_naiyou = strEncode(request.getParameter("y_basyo"));
			sql = "delete from KINMU.yotei where 区分='" + y_kubun + "' and 場所='" + y_naiyou + "'";
		}
	}
