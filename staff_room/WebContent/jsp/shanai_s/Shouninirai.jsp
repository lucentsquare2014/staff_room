...
<INPUT TYPE="hidden" NAME="body" VALUE="　<%= bsyounin.getName() %>さんへ  勤務報告書の承認をお願いします。<%= ShainMST.getName() %>より http://www.lucentsquare.co.jp:8080/staff_room/jsp/shanai_s/shanai_s.jsp?mode=2"/>
</FORM>
