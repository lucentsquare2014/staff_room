...
<INPUT TYPE="hidden" NAME="iraisha_year_month"VALUE="<%=iraisha_year_month %>" >
<INPUT TYPE="hidden" NAME="body" VALUE=" <%= b_syouninsha.getName() %> さんへ <%= iraisha_name %> さんの勤務報告書の承認をお願いします。 <%= ShainMST.getName() %> より　http://www.lucentsquare.co.jp:8080/kk_web/Menu_Gamen.jsp"/>
</FORM>
</TD>
</TR>
<%	}}%>
