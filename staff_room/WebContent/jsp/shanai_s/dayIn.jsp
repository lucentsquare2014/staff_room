			...
			<tr>
					...
					<center>
						<a href="#" onClick="return movemn1();"
							STYLE="text-decoration: none"><b>⇔
								<p>
									<font size="2">バ<br>ナ<br>｜<br>ス<br>ケ<br>ジ<br>ュ<br>｜<br>ル<br>登<br>録<br>画<br>面
									</font>
								</p>⇔
						</b></a>
					</center>
				...
				<td bgcolor="#99A5FF" height="604" width="100%" colspan="2">
					<FORM ACTION="dayInsert.jsp" METHOD="Post">
						...
						<TABLE BORDER="1" style="width: 100%;">
							...
							<TR>
								...
								<TD><INPUT TYPE="text" NAME="plan2" SIZE="23"
							...
							<TR>
								...
								<TD><INPUT TYPE="text" NAME="place2" SIZE="23"
									MAXLENGTH="30" style="width: 100%"></TD>
							</TR>
							<TR>
								<TD bgcolor="#D6FFFF" style="text-align: center;">メモ</TD>
								<TD><TEXTAREA NAME="memo" ROWS="3" COLS="30" MAXLENGTH="50"
					...
					<FORM ACTION="timeIn.jsp" METHOD="POST">
						<INPUT TYPE="hidden" NAME="id" VALUE="<%=ID%>"> <INPUT
							TYPE="hidden" NAME="no" VALUE="<%=NO%>"> <INPUT
							TYPE="hidden" NAME="s_date" VALUE="<%=BS%>"> <INPUT
