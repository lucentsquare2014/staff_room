...
<BODY BGCOLOR="#99A5FF">
	<CENTER>
		<SPAN CLASS="shadow"> <FONT COLOR="white">
				<H1>
					<FONT COLOR="GOLD">M</FONT>anagement <FONT COLOR="GOLD">S</FONT>chedule
		...
		<Table border="5" cellpadding="0" cellspacing="5" width=300
			style="border-style: solid; border-color: #D6FFFF">
			<TR>
		...
		<FORM>
			<%--
				<INPUT TYPE="button" VALUE="ログアウト" STYLE="width:150" onClick="window.location.replace('login.html')">
				 --%>
			<INPUT TYPE="button" VALUE="ログアウト" STYLE="width: 150px"
				onClick="window.location.replace('ID_PW_Nyuryoku.jsp')">

		</FORM>
		<HR WIDTH="50%" SIZE="5" COLOR="GOLD">
		<SPAN CLASS="shadow"> <FONT COLOR="white"> お知らせ </FONT>
		</SPAN> <BR> <FONT COLOR="red">2013-01-17</FONT>
		<P>
		...
		<FONT COLOR="red">2002-09-24</FONT><BR> <FONT COLOR="white">
			下記の内容を追加致しました。
			<P>
