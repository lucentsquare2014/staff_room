...
<%
	...
	ResultSet SSCHEDULE = stmt
			.executeQuery("SELECT * FROM S_TABLE WHERE GO_社員NO = '"
					+ NO + "' and S_DATE = '" + DA
					+ "' and S_START = '" + ST + "'");
					...
					<center>
						<a href="#" onClick="return movemn1();"
							STYLE="text-decoration: none"> <b>⇔
								<p>
									<font size="2">ス<br>ケ<br>ジ<br>ュ<br>｜<br>ル<br>変<br>更<br>画<br>面
									</font>
								</p>⇔
						</b>
						</a>
				...
				<td bgcolor="#99A5FF" height="604" width="100%" colspan="2">
					<FORM METHOD="Post" ACTION="timeUpdate.jsp" target="_self">
						...
						<table border="1" style="width: 100%;">
							<tr>
								<td bgcolor="#D6FFFF" align="center" style="width: 20%;"><small>本日の<br>日付
								</small></td>
								<%
									if (DA == null) {
								%>
								<td><INPUT TYPE="text" NAME="s_date1" MAXLENGTH="10"
									VALUE="<%=sFmt.format(dat)%>"
									STYLE="width: 100%; ime-mode: disabled"></td>
								<%
									} else {
								%>
								<td><INPUT TYPE="text" NAME="s_date2" MAXLENGTH="10"
							...
							<tr>
								...
								<td><SELECT NAME="starth" STYLE="width: 28%;">
										<%
											for (i = 0; i < 24; i++) {
												if (S_Shour == i) {
													if (i <= 9) {
										...
										%>
								</SELECT><small>分</small></td>
							</tr>
							<tr>
								<td align="center">∫</td>
							</tr>
							<tr>
								<td><SELECT NAME="endh" STYLE="width: 28%;">
										<%
											for (i = 0; i < 24; i++) {
												if (S_Ehour == i) {
													if (i <= 9) {
							...
							<tr>
								...
								<td>
									...
									%> <INPUT TYPE="text"
									style="ime-mode: active; width: 100%;" NAME="plan2"
									VALUE="<%=s_plan2%>" SIZE="20" MAXLENGTH="30">
									<%
										}
									%>
								</td>
							...
							<tr>
								...
								<td>
									...
									%> <INPUT TYPE="text" NAME="place2"
									VALUE="<%=s_place2%>" SIZE="20" MAXLENGTH="30"
									style="width: 100%;">
									<%
										}
									%>
							...
							<tr>
								<td bgcolor="#D6FFFF" align="center">メモ<BR>
								<small>(50字まで)</small></td>
								<td>
									<%
										if (s_memo.equals("")) {
									%> <TEXTAREA NAME="memo" ROWS="4"
										COLS="30" MAXLENGTH="50" STYLE="width: 100%;"></TEXTAREA>
									<%
										} else {
									%> <TEXTAREA NAME="memo" ROWS="4" COLS="30"
										MAXLENGTH="50" STYLE="width: 100%;"><%=s_memo%></TEXTAREA>
									<%
										}
									%>
								</td>
