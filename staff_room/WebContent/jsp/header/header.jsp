...
<!-- 					<li><a href="/staff_room/jsp/shanai_s/SystemSelect.jsp">社内スケジュール</a></li>
 ...
 -->
                    ...
                    <li>
                    <a href="/staff_room/jsp/shanai_s/ID_PW_Nyuryoku.jsp">社内システム選択画面</a>
                    </li>
					...
					<% if(user.equals("admin")){ %>
					<li class="uk-nav-divider"></li>
                    <li><a href="/staff_room/jsp/shanai_s/Pw_Nyuryoku_system.jsp">管理-社内システム</a></li>
                    <% } %>
				</ul>
			</div></li>
		...
		<li class="header"><a href="/staff_room/jsp/mail/checkbox.jsp">Mail</a></li>
