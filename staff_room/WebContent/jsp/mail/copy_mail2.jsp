...
<head>
	...
	<link rel="stylesheet" href="/staff_room/css/copy_mail2.css">
</head>
<body>
	...
	Newslist = News.getShain(sql);
		...
		<div id=button-con>
			...
			<ul>
				<li><a class="uk-button uk-button-primary" href="mailto:" id="mail"> メール作成</a></li>
				<li>
				...
				<!--  <li><a class="uk-button uk-button-primary" href="mailto:all@lucentsquare.co.jp;" id="mail"> 全社員へメール</a></li>-->
			</ul>			
		</div>
		</div>
	</div>
