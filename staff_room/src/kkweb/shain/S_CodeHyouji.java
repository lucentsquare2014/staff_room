...
public class S_CodeHyouji extends C_ChangePageBase {
		...
		try{
			...
			if(pcode.equals("sengetu")){
				...
				while(lastday>0){
					...
					String sql1 = " where year_month ='"+year_month+"' AND number ='"+number+"' AND hizuke ='"+Integer.toString(lastday)+"'";

					if(kdao.isThereTbl(sql1)){
